					...
					<div class="modal-body" >
						...
						<form method="POST" action="validation.php" onsubmit="return validation()">
							<div class="form-group">
								...
								<input type="text" autocomplete="off" name="name" class="form-control" id="username" onkeypress="clear()" placeholder="Username">
							...
							<div class="register">
								<h2><span id="create-account"><a href="signup.html">sign Up</span></a> </h2>
							</div>
